      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-red-600">Failed to load editorial team information.</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Editorial Team</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Meet the dedicated journalists and editors who bring you the latest news and stories from Dominica and the Caribbean region.
          </p>
        </div>
    ...
    <Card className="h-full hover:shadow-lg transition-shadow">
      <CardContent className="p-6">
        ...
        {author.professionalBackground && (
          <div className="mb-4">
            <h4 className="font-medium text-gray-900 mb-2 text-sm">Background</h4>
            <p className="text-gray-600 text-xs leading-relaxed">
              {author.professionalBackground.length > 200 
                ? `${author.professionalBackground.slice(0, 200)}...`
                : author.professionalBackground
              }
            </p>
          </div>
